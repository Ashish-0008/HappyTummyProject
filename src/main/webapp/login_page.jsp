...
.login-reg-panel{
    ...
    margin:auto;
    height:400px;
    background-color: rgba(15, 82, 226, 0.9);
}
.white-panel{
...
.register-show input[type="text"], .register-show input[type="password"], .register-show input[type="number"], .register-show input[type="email"]{
    width: 100%;
    display: block;
    margin:20px 0;
    padding: 10px;
    ...
    <div class="login-reg-panel">
        ...
        <div class="white-panel">
            ...
            <div class="register-show">
                ...
                <input required name="user_phone"  type="number" placeholder="Phone Number">
                <input required name="user_pass"  type="password" placeholder="Password">
                <input required name="user_cpass"  type="password" placeholder="Confirm Password">
